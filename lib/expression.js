...
function endExpression({ t, uid, _tid, _tid2 }) {
  var result = t.ExpressionStatement(
    t.logicalExpression(
      ...
      t.callExpression(
        ...
        [t.stringLiteral(uid), _tid2 ? _tid2 : _tid]
      )
    )
  )
...
function awaitExpression(path, { t, uid, _tid, _tid2 }) {
  var result = t.logicalExpression(
    '&&',
    t.logicalExpression(
      '||',
      t.awaitExpression(
